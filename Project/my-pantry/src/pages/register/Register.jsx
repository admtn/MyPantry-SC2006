  ...
  const inputs = [
    {
      ...
      errorMessage:
        "Fullname should be 4-16 characters and shouldn't include any special character",
    ...
    },
    {
      ...
      errorMessage:
        "Password should be 8-20 characters and include at least 1 uppercase, 1 lowercase, 1 number, 1 special character",
